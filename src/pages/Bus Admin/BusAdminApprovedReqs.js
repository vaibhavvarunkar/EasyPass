...
const BusAdminApprovedReqs = () => {
    ...
    const busPassReqs = useSelector((state) => state.userReducer.getApprovedPassReqs)
    ...
    const viewPassPage = (req) => {
        navigate(`/admin/bus/bus-approved-pass-requests/${req.paymentId}`, { state: { req: req } })
    }
    return (
        <>
            {
...
export default BusAdminApprovedReqs