...
const BusAdminPassReqs = () => {
    ...
    const busPassReqs = useSelector((state) => state.userReducer.getBusPassReqs)
    ...
    const viewPassPage = (req) => {
        navigate(`/admin/bus/bus-pass-requests/${req.paymentId}`, { state: { req: req } })
    }
    return (
        <>
            {
...
export default BusAdminPassReqs